...
(
    ...
    // 目标输入       
    .target_x          ('d112) ,      // 目标X坐标（有符号）
    .target_y          ('d224) ,      // 目标Y坐标（有符号）
    .target_valid      (key_flag1) ,                // 目标坐标有效信号
